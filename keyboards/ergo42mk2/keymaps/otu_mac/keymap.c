...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    XXXXXXX, XXXXXXX,     XXXXXXX, KC_TAB,         OSM(MOD_LGUI), LT(SYMB,KC_SPC), XXXXXXX, XXXXXXX, LT(SYMB,KC_SPC), OSM(MOD_RGUI), KC_ESC,          XXXXXXX, XXXXXXX,          XXXXXXX  \
  ),
  ...
  [SYMB2] = LAYOUT( \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TAB,                             KC_TAB, KC_MINS, KC_PIPE, KC_BSPC, XXXXXXX, XXXXXXX, \
  ...
  [MOUSE] = LAYOUT( \
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LGUI(KC_V), XXXXXXX, XXXXXXX, LGUI(KC_C), KC_BTN1, KC_BTN2, XXXXXXX, XXXXXXX, XXXXXXX \
  )
